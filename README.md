...
- [AutoMalTool-Access-Instructions](#automaltool-access-instructions)
...
AutoMalTool is an automated red teaming framework for LLM-based agents.

Further details can be found in our paper "Automatic Red Teaming LLM-Based Agents With Model Context Protocol Tools" [[PDF](https://ieeexplore.ieee.org/document/11511784)], TIFS 2026.

If you end up building on this code as part of a project or publication, please include a reference to our paper:

```
@article{he2026automatic,
  title={Automatic red teaming llm-based agents with model context protocol tools},
  author={He, Ping and Li, Changjiang and Zhao, Binbin and Du, Tianyu and Ji, Shouling},
...
[> FORM TO REQUEST ACCESS <](https://forms.gle/L8FK8Fzk86a83Vby8)
...
- If you are in research (industrial) labs, send us an email from your company’s email account and introduce yourself and company. In the email, please attach a justification letter (in PDF format) in official letterhead. The letter needs to state clearly the reasons why AutoMalTool is being requested.

Please note that an email not following the conditions might be ignored.
